"""Приводит список менеджеров к согласованному: Азамат, Куба, Минура, Айбек, Минайым, Айниса.
...
MANAGERS = ["Азамат", "Куба", "Минура", "Айбек", "Минайым", "Айниса"]
...
class Command(BaseCommand):
    help = "Синхронизирует список менеджеров с согласованным (Азамат/Куба/Минура/Айбек/Минайым/Айниса)"
