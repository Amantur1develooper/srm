...
def node_detail(request, pk):
    ...
    ctx = {
        ...
        "entries": node.entries.select_related("author").order_by("-created_at")[:200],
        "tasks": node.tasks.select_related("assignee").order_by("status", "due_date"),
        "decisions": node.decisions.select_related("responsible").order_by("-created_at"),
